							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										...
										<p><b><font color="red">Si vous voulez réactiver un membre, appuyez sur restaurer !</font></b></span></p>
									</div>
								</div>
							</div>
                                        ...
                                        foreach ($members as $memb) {
                                           ...
                                           <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/restore-membre/{{$memb->id}}" title="Restorer membre">
                                                <button class="btn btn-warning warning-icon-notika" onclick="return(confirm('Valider restauration ?'));"><i class="notika-icon notika-sent"> <font face="calibri"> Restaurer</font></i></button>
                                                </a>
                                            </td>
                                           </tr>
                                           <?php $i++;
