							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Nouveau Secteurs</h2>
										<p>Gestion des secteurs et commissions de la Daara</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
									<a href="secteur"><button data-placement="left" title="Download Report" class="btn"><i class="notika-icon notika-sent"></i> Liste secteurs</button></a>
								</div>
							</div>
						</div>
					</div>
                    ...
                    <div class="form-element-list mg-t-30">
                        ...
                        <div class="form-example-int">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" name="libelleSecteur" class="form-control input-sm" placeholder="Nom du secteur ici...">
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="form-example-int">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    ...
                                    <select class="selectpicker" data-live-search="true" name="responsable">
