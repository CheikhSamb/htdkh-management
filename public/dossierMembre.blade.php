                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="inbox-left-sd">
                        ...
                        <div class="inbox-status">
                            <div class="well" align="center"><H4>PHOTO MEMBRE ICI</H4></div>
                            <div class="form-group">
                                <font size="2">
                                    <label>Prénom</label>
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="prenom" value="Moustapha">
                                    </div>
                                </font>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <font size="2">
                                    <label>Nom</label>
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="prenom" value="{{$member->nom}}">
                                    </div>
                                </font>
                            </div>
                            <div class="form-group">
                                <font size="2">
                                    ...
                                    <div class="nk-int-st">
                                       <input type="text" class="form-control" name="dateNaiss" data-mask="99/99/9999" placeholder="jj/mm/aaaa" value="15/12/1992">
                                    </div>
                                </font>
                            </div>
                            <div class="form-group">
                                <font size="2">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="prenom" value="PA">
                                    </div>
                                </font>
                            </div>
                        </div>
                        
                        <!-- <hr><div class="inbox-status">
                    ...
                    <div class="inbox-text-list sm-res-mg-t-30">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcomb-report">
                                    <a href="/liste-membre"><button class="btn"><i class="notika-icon notika-support"> <font face="calibri">Liste membres</font> </i></button></a>
                                </div>
                            </div>
