        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <h5><font color="#fff" face="impact" size="6px">HIZBUT TARQIYYAH DAROU KHOUDOSS  </font></h5>
                        <font color="#000" size="4px"><B>GESTION DES MEMBRES ET ADMINISTRATIVE</B></font>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <?php $nb =  10;?>
                            <h2><span class="counter"><?=$nb;?>,000</span></h2>
                            <p>Total membres</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter">35,000</span></h2>
                            <p>Garçons</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter">15,000</span></h2>
                            <p>Filles</p>
                        </div>
